      ...
      <div className="w-full max-w-sm animate-fade-in-up">
        <div className="bg-white rounded-2xl shadow-2xl border border-gray-100 p-7">
          ...
          <div className="text-center mb-6">
            ...
            <h2 className="font-heading font-bold text-xl text-text-dark">Staff Login</h2>
            <p className="text-sm text-text-muted mt-1">Sampada Greens Operations</p>
          </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  placeholder="staff@sampadagreen.com"
